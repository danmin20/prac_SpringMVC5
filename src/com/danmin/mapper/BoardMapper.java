...
public interface BoardMapper {
	...
	@Select("select a2.user_name as content_writer_name, "
			...
			+ "    a1.content_subject, a1.content_text, a1.content_file, a1.content_writer_idx " + "from content_table a1, user_table a2 "
